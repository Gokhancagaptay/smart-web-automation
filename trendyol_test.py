...
def main():
    print("\n" + "="*70)
    print("🛒 TRENDYOL AI TEST (Pure AI - No IDs)")
    print("="*70)
    
    # Reporter
    reporter = TestReporter("trendyol_ai_test")
    ...
    try:
        # 1. Anasayfa
        print("\n🌍 1. Trendyol Anasayfasına Gidiliyor...")
        ...
        # Email
        email = os.getenv("TRENDYOL_EMAIL", "test@example.com")
        ...
        # Password
        password = os.getenv("TRENDYOL_PASSWORD", "testpass123")
        ...
        # 3. Ürün arama
        print("\n🔍 3. Ürün Aranıyor: laptop...")
        driver.get("https://www.trendyol.com")
        bot.smart_wait("page_ready", timeout=10)
        
        if bot.interact("search", text="laptop", target_text="Ara"):
            print("   ✅ Arama yapıldı")
